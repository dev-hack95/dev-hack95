...
#### Devops/Mlops
- ![](https://img.icons8.com/color/2x/linux.png), DVC, MLFlow, CI/CD, ![](https://img.icons8.com/color/2x/jenkins.png), ![](https://img.icons8.com/color/2x/docker.png), Kubernetes, GitVCS, ![](https://github.githubassets.com/images/modules/site/features/actions-icon-actions.svg)
- Go(Beginner)
